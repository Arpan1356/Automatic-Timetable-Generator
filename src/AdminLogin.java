...
public class AdminLogin implements ActionListener {
	...
	//panel1 has the contents of New Data
	...
	public AdminLogin() {
		...
		tabbedPane = new JTabbedPane(JTabbedPane.TOP);// Outer Tab
		MainFrame.add(tabbedPane);
		tabbedPane.addTab("New Data", panel1);
		panel1.setLayout(new GridLayout(1, 1));

		tabbedPane_1 = new JTabbedPane(JTabbedPane.TOP);//Inner Tab
		panel1.add(tabbedPane_1);//Adding Inner tab inside the panel of outer tab

		panel = new JPanel();//coursed manager's panel
		...
		String[] courses_col = {"NAME", "CODE", "DEPARTMENT"};
		table = new JTable(null,courses_col) {
			public boolean isCellEditable(int rowIndex, int colIndex) {
				return false;
			}
		};
		table.setBorder(new MatteBorder(2, 2, 2, 2, (Color) new Color(0, 0, 0)));
		table.setBounds(305, 32, 475, 356);
		
		panel.add(table);
		//table.setBackground((Color)new Color(45,45,45));
